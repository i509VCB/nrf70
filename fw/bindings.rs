...
pub const RPU_MCU_MAX_BOOT_VECTORS: u32 = 0x4;
...
pub const RPU_REG_MIPS_MCU_TIMER: u32 = 0xa400004c;
pub const RPU_REG_MIPS_MCU_TIMER_RESET_VAL: u32 = 0xffffff;
pub const RPU_REG_MIPS_MCU_UCCP_INT_CLEAR: u32 = 0xa400000c;
pub const RPU_REG_BIT_MIPS_WATCHDOG_INT_CLEAR: u32 = 0x1;
...
pub const RPU_MEM_OTP_PACKAGE_TYPE: u32 = 0xb0004fd4;
...
pub const RPU_MEM_UMAC_PEND_Q_BMP: u32 = 0xb0004fbc;
...
pub const NUM_PCB_LOSS_OFFSET: u32 = 0x4;
pub const DEF_RF_PARAMS : & [u8 ; 227] = b"007077003F032424001000002800323500000CF008087D8105010071630300EED501001F6F00003B350100F52E0000E35E0000B7B6000066EFFEFFB5F60000896200007A840200E28FFCFF080808080408120100000000A1A10178000000080050003B020726181818181A120A140E0600\0" ;
...
pub const PHY_CALIB_FLAG_ENHANCED_TXDC: u32 = 0x40;
...
pub const DEF_PHY_CALIB: u32 = 0x3007b;
...
pub const QFN_PACKAGE_INFO: u32 = 0x5146;
pub const CSP_PACKAGE_INFO: u32 = 0x4345;
pub const PD_ADJUST_VAL: u32 = 0x0;
pub const RX_GAIN_OFFSET_LB_CHAN: u32 = 0x0;
pub const RX_GAIN_OFFSET_HB_LOW_CHAN: u32 = 0x0;
pub const RX_GAIN_OFFSET_HB_MID_CHAN: u32 = 0x0;
pub const RX_GAIN_OFFSET_HB_HIGH_CHAN: u32 = 0x0;
pub const SYSTEM_OFFSET_LB: u32 = 0x3;
pub const SYSTEM_OFFSET_HB_CHAN_LOW: u32 = 0x3;
pub const SYSTEM_OFFSET_HB_CHAN_MID: u32 = 0x3;
pub const SYSTEM_OFFSET_HB_CHAN_HIGH: u32 = 0x3;
pub const QFN_XO_VAL: u32 = 0x2a;
pub const QFN_MAX_TX_PWR_DSSS: u32 = 0x54;
pub const QFN_MAX_TX_PWR_LB_MCS7: u32 = 0x40;
pub const QFN_MAX_TX_PWR_LB_MCS0: u32 = 0x40;
pub const QFN_MAX_TX_PWR_HB_LOW_CHAN_MCS7: u32 = 0x34;
pub const QFN_MAX_TX_PWR_HB_MID_CHAN_MCS7: u32 = 0x34;
pub const QFN_MAX_TX_PWR_HB_HIGH_CHAN_MCS7: u32 = 0x30;
pub const QFN_MAX_TX_PWR_HB_LOW_CHAN_MCS0: u32 = 0x38;
pub const QFN_MAX_TX_PWR_HB_MID_CHAN_MCS0: u32 = 0x34;
pub const QFN_MAX_TX_PWR_HB_HIGH_CHAN_MCS0: u32 = 0x30;
pub const QFN_MAX_CHIP_TEMP: u32 = 0x43;
pub const QFN_MIN_CHIP_TEMP: u32 = 0x7;
pub const QFN_LB_MAX_PWR_BKF_HI_TEMP: u32 = 0xfc;
pub const QFN_LB_MAX_PWR_BKF_LOW_TEMP: u32 = 0x0;
pub const QFN_HB_MAX_PWR_BKF_HI_TEMP: u32 = 0xf8;
pub const QFN_HB_MAX_PWR_BKF_LOW_TEMP: u32 = 0xfc;
pub const QFN_LB_VBT_LT_VLOW: u32 = 0xfc;
pub const QFN_HB_VBT_LT_VLOW: u32 = 0xf8;
pub const QFN_LB_VBT_LT_LOW: u32 = 0x0;
pub const QFN_HB_VBT_LT_LOW: u32 = 0xfc;
pub const CSP_XO_VAL: u32 = 0x2a;
pub const CSP_MAX_TX_PWR_DSSS: u32 = 0x48;
pub const CSP_MAX_TX_PWR_LB_MCS7: u32 = 0x44;
pub const CSP_MAX_TX_PWR_LB_MCS0: u32 = 0x44;
pub const CSP_MAX_TX_PWR_HB_LOW_CHAN_MCS7: u32 = 0x3c;
pub const CSP_MAX_TX_PWR_HB_MID_CHAN_MCS7: u32 = 0x3c;
pub const CSP_MAX_TX_PWR_HB_HIGH_CHAN_MCS7: u32 = 0x3c;
pub const CSP_MAX_TX_PWR_HB_LOW_CHAN_MCS0: u32 = 0x3c;
pub const CSP_MAX_TX_PWR_HB_MID_CHAN_MCS0: u32 = 0x3c;
pub const CSP_MAX_TX_PWR_HB_HIGH_CHAN_MCS0: u32 = 0x3c;
pub const CSP_MAX_CHIP_TEMP: u32 = 0x43;
pub const CSP_MIN_CHIP_TEMP: u32 = 0x7;
pub const CSP_LB_MAX_PWR_BKF_HI_TEMP: u32 = 0xec;
pub const CSP_LB_MAX_PWR_BKF_LOW_TEMP: u32 = 0x0;
pub const CSP_HB_MAX_PWR_BKF_HI_TEMP: u32 = 0xfc;
pub const CSP_HB_MAX_PWR_BKF_LOW_TEMP: u32 = 0xf4;
pub const CSP_LB_VBT_LT_VLOW: u32 = 0xfc;
pub const CSP_HB_VBT_LT_VLOW: u32 = 0xec;
pub const CSP_LB_VBT_LT_LOW: u32 = 0x0;
pub const CSP_HB_VBT_LT_LOW: u32 = 0xf8;
...
pub const RPU_MEM_LMAC_PATCH_BIMG: u32 = 0x8004b400;
pub const LMAC_BOOT_SIG: u32 = 0x5a5a5a5a;
pub const LMAC_ROM_PATCH_OFFSET: u32 = 0xb400;
...
pub const BCN_TIMEOUT: u32 = 0x4e20;
...
pub const DISABLE_DFS_CHANNELS: u32 = 0x2;
...
pub const TX_FLAGS_DSCP_TOS_MASK: u32 = 0xffff;
pub const TX_FLAGS_DSCP_TOS_SHIFT: u32 = 0x0;
...
pub const IEEE80211_STYPE_DISASSOC: u32 = 0xa0;
pub const IEEE80211_STYPE_DEAUTH: u32 = 0xc0;
...
pub const CONNECT_COMMON_INFO_SECURITY: u32 = 0x10000;
...
pub const PATCH_SIGNATURE: u32 = 0xdead1eaf;
pub const PATCH_HASH_LEN: u32 = 0x20;
pub const PATCH_NUM_IMAGES: u32 = 0x4;
pub const RPU_FAMILY: u32 = 0x1;
pub const RPU_MAJOR_VERSION: u32 = 0x2;
pub const RPU_MINOR_VERSION: u32 = 0xb;
pub const RPU_PATCH_VERSION: u32 = 0x2;
#[repr(u32)]
...
#[repr(C, packed)]
pub struct host_rpu_msg<FAM: ?Sized = [::core::ffi::c_schar; 0]> {
    #[doc = " Header"]
    pub hdr: host_rpu_msg_hdr,
    #[doc = " Type of the RPU message see &enum host_rpu_msg_type"]
    pub type_: ::core::ffi::c_int,
    #[doc = " Actual message"]
    pub msg: ::core::mem::ManuallyDrop<FAM>,
}
impl host_rpu_msg<[::core::ffi::c_schar]> {}
impl host_rpu_msg<[::core::ffi::c_schar; 0]> {}
...
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
pub struct tx_pwr_systm_offset {
...
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
pub struct temp_volt_depend_params {
...
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
pub struct phy_rf_params {
    pub reserved: [::core::ffi::c_uchar; 6usize],
    pub xo_offset: xo_freq_offset,
    pub pd_adjust_val: pd_adst_val,
    pub syst_tx_pwr_offset: tx_pwr_systm_offset,
    pub max_pwr_ceil: tx_pwr_ceil,
    pub rx_gain_offset: rx_gain_offset,
    pub temp_volt_backoff: temp_volt_depend_params,
...
pub enum RF_PARAMS_OFFSETS {
    XO_FREQ_BYTE_OFFSET = 6,
    PD_ADST_VAL_BYTE_OFFSET = 7,
    TX_PWR_SYSTM_BYTE_OFFSET = 11,
    TX_PWR_CEIL_BYTE_OFFSET = 15,
    RX_GAIN_BYTE_OFFSET = 24,
    VT_DEPEND_PARAMS_BYTE_OFFSET = 28,
}
#[repr(u32)]
#[doc = " RF Params from byte starting with offset\n TX_PWR_CEIL_BYTE_OFFSET contains the\n TX power celings based on DSSS, OFDM , Frequency\n band and MCS.\n In 5GHz band we have three subbands based on\n channel frequency, we have divided them in to\n LOW BAND, MID BAND and HIGH BAND"]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq, num_enum::TryFromPrimitive)]
pub enum MAX_POWER_OFFSETS {
    MAX_OP_PWR_DSSS_OFST = 0,
    MAX_OP_PWR_2PT4GHZ_OFDM_MCS7 = 1,
    MAX_OP_PWR_2PT4GHZ_OFDM_MCS0 = 2,
    MAX_OP_PWR_5GHZ_LB_MCS7 = 3,
    MAX_OP_PWR_5GHZ_MID_MCS7 = 4,
    MAX_OP_PWR_5GHZ_HI_MCS7 = 5,
    MAX_OP_PWR_5GHZ_LB_MCS0 = 6,
    MAX_OP_PWR_5GHZ_MID_MCS0 = 7,
    MAX_OP_PWR_5GHZ_HI_MCS0 = 8,
}
#[repr(u32)]
...
pub enum sys_events {
    ...
    #[doc = " Response to CMD_CHANNEL"]
    EVENT_CHANNEL_SET_DONE = 8,
    #[doc = " Response to CMD_RAW_CONFIG_MODE"]
    EVENT_MODE_SET_DONE = 9,
    #[doc = " Response to CMD_RAW_CONFIG_FILTER"]
    EVENT_FILTER_SET_DONE = 10,
    #[doc = " Tx done event for the Raw Tx"]
    EVENT_RAW_TX_DONE = 11,
}
#[repr(u32)]
...
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq, num_enum::TryFromPrimitive)]
pub enum data_retrieve_mechanism {
    #[doc = " Retrieves data from the AP using a PS-Poll frame"]
    PS_POLL_FRAME = 0,
    #[doc = " Retrieves data from the AP using a QoS Null frame"]
    QOS_NULL_FRAME = 1,
    #[doc = " For future implementation. The RPU will decide which frame to use"]
    AUTOMATIC = 2,
}
...
pub struct cmd_sys_init {
    ...
    pub ps_data_retrieval_mech: ::core::ffi::c_uchar,
}
...
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
pub struct cmd_raw_config_filter {
    #[doc = " UMAC header, @ref sys_head."]
    pub sys_head: sys_head,
    #[doc = " Interface index."]
    pub if_index: ::core::ffi::c_uchar,
...
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
pub struct event_raw_config_mode {
    #[doc = " UMAC header, @ref sys_head."]
    pub sys_head: sys_head,
    #[doc = " Interface index."]
    pub if_index: ::core::ffi::c_uchar,
...
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
pub struct event_raw_config_filter {
    #[doc = " UMAC header, @ref sys_head."]
    pub sys_head: sys_head,
    #[doc = " Interface index."]
    pub if_index: ::core::ffi::c_uchar,
    ...
    pub capture_len: ::core::ffi::c_uchar,
...
#[repr(C, packed)]
pub struct rpu_cmd_coex_config_info<FAM: ?Sized = [::core::ffi::c_uchar; 0]> {
    #[doc = " Length of coexistence configuration data"]
    pub len: ::core::ffi::c_uint,
    #[doc = " Coexistence configuration data"]
    pub coex_cmd: ::core::mem::ManuallyDrop<FAM>,
}
impl rpu_cmd_coex_config_info<[::core::ffi::c_uchar]> {}
impl rpu_cmd_coex_config_info<[::core::ffi::c_uchar; 0]> {}
...
#[repr(C, packed)]
pub struct rpu_evnt_coex_config_info<FAM: ?Sized = [::core::ffi::c_uchar; 0]> {
    #[doc = " Length of coexistence configuration data"]
    pub len: ::core::ffi::c_uint,
    #[doc = " Coexistence configuration data"]
    pub coex_event: ::core::mem::ManuallyDrop<FAM>,
}
impl rpu_evnt_coex_config_info<[::core::ffi::c_uchar]> {}
impl rpu_evnt_coex_config_info<[::core::ffi::c_uchar; 0]> {}
...
#[repr(C, packed)]
pub struct rpu_cmd_rftest_info<FAM: ?Sized = [::core::ffi::c_uchar; 0]> {
    #[doc = " length of the rf test command"]
    pub len: ::core::ffi::c_uint,
    #[doc = " Rf test command data"]
    pub rfcmd: ::core::mem::ManuallyDrop<FAM>,
}
impl rpu_cmd_rftest_info<[::core::ffi::c_uchar]> {}
impl rpu_cmd_rftest_info<[::core::ffi::c_uchar; 0]> {}
...
#[repr(C, packed)]
pub struct rpu_evnt_rftest_info<FAM: ?Sized = [::core::ffi::c_uchar; 0]> {
    #[doc = " length of the rf test event"]
    pub len: ::core::ffi::c_uint,
    #[doc = " Rf test event data"]
    pub rfevent: ::core::mem::ManuallyDrop<FAM>,
}
impl rpu_evnt_rftest_info<[::core::ffi::c_uchar]> {}
impl rpu_evnt_rftest_info<[::core::ffi::c_uchar; 0]> {}
...
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq, num_enum::TryFromPrimitive)]
pub enum tx_flags {
    TX_FLAG_TWT_EMERGENCY_TX = -2147483648,
    TX_FLAG_CHKSUM_AVAILABLE = 1073741824,
}
...
#[repr(C, packed)]
pub struct tx_buff<FAM: ?Sized = [tx_buff_info; 0]> {
    ...
    pub tx_buff_info: ::core::mem::ManuallyDrop<FAM>,
}
impl tx_buff<[tx_buff_info]> {}
impl tx_buff<[tx_buff_info; 0]> {}
#[doc = " @brief This structure represents the Tx done event(CMD_TX_BUFF_DONE).\n"]
#[repr(C, packed)]
pub struct tx_buff_done<FAM: ?Sized = [::core::ffi::c_uchar; 0]> {
    ...
    pub tx_status_code: ::core::mem::ManuallyDrop<FAM>,
}
impl tx_buff_done<[::core::ffi::c_uchar]> {}
impl tx_buff_done<[::core::ffi::c_uchar; 0]> {}
#[repr(u32)]
...
#[repr(C, packed)]
pub struct rx_buff<FAM: ?Sized = [rx_buff_info; 0]> {
    #[doc = " Header @ref umac_head"]
    pub umac_head: umac_head,
    ...
    pub rx_buff_info: ::core::mem::ManuallyDrop<FAM>,
}
impl rx_buff<[rx_buff_info]> {}
impl rx_buff<[rx_buff_info; 0]> {}
...
pub enum umac_commands {
    #[doc = " Trigger a new scan umac_cmd_scan"]
    UMAC_CMD_TRIGGER_SCAN = 0,
    #[doc = " Request for scan results umac_cmd_get_scan_results"]
    UMAC_CMD_GET_SCAN_RESULTS = 1,
    #[doc = " Send authentication request to AP umac_cmd_auth"]
    UMAC_CMD_AUTHENTICATE = 2,
    #[doc = " Send associate request to AP umac_cmd_assoc"]
    UMAC_CMD_ASSOCIATE = 3,
    #[doc = " Send deauthentication request to AP umac_cmd_disconn"]
    UMAC_CMD_DEAUTHENTICATE = 4,
    #[doc = " Set wiphy parameters umac_cmd_set_wiphy"]
    UMAC_CMD_SET_WIPHY = 5,
    #[doc = " Add new key umac_cmd_key"]
    UMAC_CMD_NEW_KEY = 6,
    #[doc = " Delete key umac_cmd_key"]
    UMAC_CMD_DEL_KEY = 7,
    #[doc = " Set default key to use umac_cmd_set_key"]
    UMAC_CMD_SET_KEY = 8,
    #[doc = " Unused"]
    UMAC_CMD_GET_KEY = 9,
    #[doc = " Unused"]
    UMAC_CMD_NEW_BEACON = 10,
    #[doc = " Change the beacon on an AP interface umac_cmd_set_beacon"]
    UMAC_CMD_SET_BEACON = 11,
    #[doc = " Set the BSS umac_cmd_set_bss"]
    UMAC_CMD_SET_BSS = 12,
    #[doc = " Start soft AP operation on an AP interface umac_cmd_start_ap"]
    UMAC_CMD_START_AP = 13,
    #[doc = " Stop soft AP operation umac_cmd_stop_ap"]
    UMAC_CMD_STOP_AP = 14,
    #[doc = " Create new interface umac_cmd_add_vif"]
    UMAC_CMD_NEW_INTERFACE = 15,
    #[doc = " Change interface configuration umac_cmd_chg_vif_attr"]
    UMAC_CMD_SET_INTERFACE = 16,
    #[doc = " Delete interface umac_cmd_del_vif"]
    UMAC_CMD_DEL_INTERFACE = 17,
    #[doc = " Change interface flags umac_cmd_chg_vif_state"]
    UMAC_CMD_SET_IFFLAGS = 18,
    #[doc = " Add a new station umac_cmd_add_sta"]
    UMAC_CMD_NEW_STATION = 19,
    #[doc = " Delete station umac_cmd_del_sta"]
    UMAC_CMD_DEL_STATION = 20,
    #[doc = " Change station info umac_cmd_chg_sta"]
    UMAC_CMD_SET_STATION = 21,
    #[doc = " Get station info umac_cmd_get_sta"]
    UMAC_CMD_GET_STATION = 22,
    #[doc = " Start the P2P device cmd_start_p2p"]
    UMAC_CMD_START_P2P_DEVICE = 23,
    #[doc = " Stop the P2P device umac_cmd_stop_p2p_dev"]
    UMAC_CMD_STOP_P2P_DEVICE = 24,
    #[doc = " Remain awake on the specified channel umac_cmd_remain_on_channel"]
    UMAC_CMD_REMAIN_ON_CHANNEL = 25,
    #[doc = " Cancel a pending ROC duration umac_cmd_cancel_remain_on_channel"]
    UMAC_CMD_CANCEL_REMAIN_ON_CHANNEL = 26,
    #[doc = " Unused"]
    UMAC_CMD_SET_CHANNEL = 27,
    #[doc = " Unused"]
    UMAC_CMD_RADAR_DETECT = 28,
    #[doc = " Whitelist filter based on frame types umac_cmd_mgmt_frame_reg"]
    UMAC_CMD_REGISTER_FRAME = 29,
    #[doc = " Send a management frame umac_cmd_mgmt_tx"]
    UMAC_CMD_FRAME = 30,
    #[doc = " Unused"]
    UMAC_CMD_JOIN_IBSS = 31,
    #[doc = " Unused"]
    UMAC_CMD_WIN_STA_CONNECT = 32,
    #[doc = " Power save Enable/Disable umac_cmd_set_power_save"]
    ...
    #[doc = " Unused"]
    UMAC_CMD_RESUME = 36,
    #[doc = " QOS map umac_cmd_set_qos_map"]
    UMAC_CMD_SET_QOS_MAP = 37,
    #[doc = " Get Channel info umac_cmd_get_channel"]
    UMAC_CMD_GET_CHANNEL = 38,
    #[doc = " Get Tx power level umac_cmd_get_tx_power"]
    UMAC_CMD_GET_TX_POWER = 39,
    #[doc = " Get interface cmd_get_interface"]
    UMAC_CMD_GET_INTERFACE = 40,
    #[doc = " Get Wiphy info cmd_get_wiphy"]
    UMAC_CMD_GET_WIPHY = 41,
    #[doc = " Get hardware address cmd_get_ifhwaddr"]
    UMAC_CMD_GET_IFHWADDR = 42,
    #[doc = " Set hardware address cmd_set_ifhwaddr"]
    UMAC_CMD_SET_IFHWADDR = 43,
    #[doc = " Get regulatory domain umac_cmd_get_reg"]
    UMAC_CMD_GET_REG = 44,
    #[doc = " Unused"]
    UMAC_CMD_SET_REG = 45,
    #[doc = " Set regulatory domain  cmd_req_set_reg"]
    UMAC_CMD_REQ_SET_REG = 46,
    #[doc = " Config UAPSD umac_cmd_config_uapsd"]
    UMAC_CMD_CONFIG_UAPSD = 47,
    #[doc = " Config TWT umac_cmd_config_twt"]
    UMAC_CMD_CONFIG_TWT = 48,
    #[doc = " Teardown TWT umac_cmd_teardown_twt"]
    UMAC_CMD_TEARDOWN_TWT = 49,
    #[doc = " Abort scan umac_cmd_abort_scan"]
    UMAC_CMD_ABORT_SCAN = 50,
    #[doc = " Multicast filter umac_cmd_mcast_filter"]
    UMAC_CMD_MCAST_FILTER = 51,
    #[doc = " Change macaddress umac_cmd_change_macaddr"]
    UMAC_CMD_CHANGE_MACADDR = 52,
    #[doc = " Set powersave timeout umac_cmd_set_power_save_timeout"]
    UMAC_CMD_SET_POWER_SAVE_TIMEOUT = 53,
    #[doc = " Get connection information umac_cmd_conn_info"]
    UMAC_CMD_GET_CONNECTION_INFO = 54,
    #[doc = " Get power save information umac_cmd_get_power_save_info"]
    UMAC_CMD_GET_POWER_SAVE_INFO = 55,
    #[doc = " Set listen interval umac_cmd_set_listen_interval"]
    UMAC_CMD_SET_LISTEN_INTERVAL = 56,
    #[doc = " Configure extended power save umac_cmd_config_extended_ps"]
    UMAC_CMD_CONFIG_EXTENDED_PS = 57,
    #[doc = " Configure quiet period umac_cmd_config_quiet_period"]
    UMAC_CMD_CONFIG_QUIET_PERIOD = 58,
}
#[repr(u32)]
...
pub enum umac_events {
    ...
    #[doc = " Indicate scan started umac_event_trigger_scan"]
    UMAC_EVENT_TRIGGER_SCAN_START = 257,
    #[doc = " Unused"]
    UMAC_EVENT_SCAN_ABORTED = 258,
    #[doc = " Indicate scan done umac_event_scan_done"]
    UMAC_EVENT_SCAN_DONE = 259,
    #[doc = " Scan result event umac_event_new_scan_results"]
    UMAC_EVENT_SCAN_RESULT = 260,
    #[doc = " Authentication status umac_event_mlme"]
    UMAC_EVENT_AUTHENTICATE = 261,
    #[doc = " Association status umac_event_mlme"]
    UMAC_EVENT_ASSOCIATE = 262,
    #[doc = " Unused"]
    UMAC_EVENT_CONNECT = 263,
    #[doc = " Station deauth event umac_event_mlme"]
    UMAC_EVENT_DEAUTHENTICATE = 264,
    #[doc = " Station disassoc event umac_event_mlme"]
    UMAC_EVENT_DISASSOCIATE = 265,
    #[doc = " Station added indication umac_event_new_station"]
    UMAC_EVENT_NEW_STATION = 266,
    #[doc = " Station added indication umac_event_new_station"]
    UMAC_EVENT_DEL_STATION = 267,
    #[doc = " Station info indication umac_event_new_station"]
    UMAC_EVENT_GET_STATION = 268,
    #[doc = " remain on channel event event_remain_on_channel"]
    UMAC_EVENT_REMAIN_ON_CHANNEL = 269,
    #[doc = " Unused"]
    UMAC_EVENT_CANCEL_REMAIN_ON_CHANNEL = 270,
    #[doc = " Unused"]
    UMAC_EVENT_DISCONNECT = 271,
    #[doc = " RX management frame umac_event_mlme"]
    UMAC_EVENT_FRAME = 272,
    #[doc = " Cookie mapping for UMAC_CMD_FRAME umac_event_cookie_rsp"]
    UMAC_EVENT_COOKIE_RESP = 273,
    #[doc = " TX management frame transmitted umac_event_mlme"]
    UMAC_EVENT_FRAME_TX_STATUS = 274,
    #[doc = " umac_event_vif_state"]
    UMAC_EVENT_IFFLAGS_STATUS = 275,
    #[doc = " Send Tx power umac_event_get_tx_power"]
    UMAC_EVENT_GET_TX_POWER = 276,
    #[doc = " Send Channel info umac_event_get_channel"]
    UMAC_EVENT_GET_CHANNEL = 277,
    #[doc = " umac_event_set_interface"]
    ...
    #[doc = " Display scan result umac_event_new_scan_display_results"]
    UMAC_EVENT_SCAN_DISPLAY_RESULT = 291,
    #[doc = " umac_event_cmd_status"]
    UMAC_EVENT_CMD_STATUS = 292,
    #[doc = " umac_event_new_scan_results"]
    UMAC_EVENT_BSS_INFO = 293,
    #[doc = " Send TWT response information umac_cmd_config_twt"]
    UMAC_EVENT_CONFIG_TWT = 294,
    #[doc = " Send TWT teardown information umac_cmd_teardown_twt"]
    UMAC_EVENT_TEARDOWN_TWT = 295,
    #[doc = " Send block or unblock state umac_event_twt_sleep"]
    UMAC_EVENT_TWT_SLEEP = 296,
    #[doc = " Unused"]
    UMAC_EVENT_COALESCING = 297,
    #[doc = " Unused"]
    UMAC_EVENT_MCAST_FILTER = 298,
    #[doc = " send connection information umac_event_conn_info."]
    UMAC_EVENT_GET_CONNECTION_INFO = 299,
    #[doc = " umac_event_power_save_info"]
...
pub enum chan_width {
    ...
    #[doc = " 20 MHz HT channel"]
    CHAN_WIDTH_20 = 1,
    #[doc = " 40 MHz channel, the ATTR_CENTER_FREQ1 must be provided as well"]
    CHAN_WIDTH_40 = 2,
    #[doc = " 80 MHz channel, the ATTR_CENTER_FREQ1 must be provided as well"]
    CHAN_WIDTH_80 = 3,
    #[doc = " 80+80 MHz channel, the ATTR_CENTER_FREQ1 and\n  ATTR_CENTER_FREQ2 must be provided as well"]
    CHAN_WIDTH_80P80 = 4,
...
impl iftype {
    pub const IFTYPE_MAX: iftype = iftype::STA_PROMISC_TX_INJECTOR;
}
#[repr(u32)]
...
pub enum iftype {
    ...
    #[doc = " P2P group owner"]
    IFTYPE_P2P_GO = 9,
    #[doc = " P2P device use the UMAC_CMD_START_P2P_DEVICE &\n  UMAC_CMD_STOP_P2P_DEVICE commands to create and destroy one"]
...
impl scan_params<[::core::ffi::c_uint]> {}
impl scan_params<[::core::ffi::c_uint; 0]> {}
...
pub struct connect_common_info {
    ...
    #[doc = " IE's ie"]
    pub wpa_ie: ie,
    #[doc = " VHT Capability information element ht_vht_capabilities"]
...
pub struct sta_info {
    ...
    #[doc = " station flags sta_flag_update"]
    ...
    #[doc = " Station connected BSS params. sta_bss_parameters"]
...
pub struct umac_hdr {
    ...
    #[doc = " Interface information index_ids"]
    pub ids: index_ids,
}
...
pub struct umac_cmd_auth {
    ...
    #[doc = " Indicate which of the following parameters are valid"]
    pub valid_fields: ::core::ffi::c_uint,
    #[doc = " Information to be passed in the authentication command umac_auth_info"]
...
pub struct umac_assoc_info {
    ...
    #[doc = " MAC address (various uses)"]
    pub bssid: [::core::ffi::c_uchar; 6usize],
    #[doc = "  WPA information element data. ie"]
    pub wpa_ie: ie,
    #[doc = " Whether management frame protection (IEEE 802.11w) is used for the association"]
...
pub struct umac_cmd_add_vif {
    ...
    #[doc = " Indicate which of the following parameters are valid"]
    pub valid_fields: ::core::ffi::c_uint,
    #[doc = " VIF specific information to be passed to the RPU umac_add_vif_info"]
...
pub struct umac_cmd_key {
    ...
    #[doc = " Indicate which of the following parameters are valid"]
    pub valid_fields: ::core::ffi::c_uint,
    #[doc = " Key information. umac_key_info"]
    pub key_info: umac_key_info,
...
pub struct umac_cmd_set_bss {
    ...
    #[doc = " Indicate which of the following parameters are valid"]
    pub valid_fields: ::core::ffi::c_uint,
    #[doc = " BSS specific information to be passed to the RPU umac_bss_info"]
...
pub struct umac_set_wiphy_info {
    ...
    #[doc = " TX queue parameters txq_params"]
    pub txq_params: txq_params,
    #[doc = " Tx power settings tx_power_setting tx_power_setting"]
...
pub struct umac_cmd_del_sta {
    ...
    #[doc = " Indicate which of the following parameters are valid"]
    pub valid_fields: ::core::ffi::c_uint,
    #[doc = " Information regarding the station to be deleted umac_del_sta_info"]
...
pub struct umac_cmd_get_sta {
    #[doc = " Header umac_hdr"]
    pub umac_hdr: umac_hdr,
    #[doc = " Information regarding the station to get umac_get_sta_info"]
...
pub struct umac_chg_sta_info {
    ...
    #[doc = " Supported rates in IEEE 802.11 format supp_rates"]
    pub supp_rates: supp_rates,
    #[doc = " Extended capabilities of the station ext_capability"]
    pub ext_capability: ext_capability,
    #[doc = " Supported channels in IEEE 802.11 format supported_channels"]
    pub supported_channels: supported_channels,
    #[doc = " Supported oper classes in IEEE 802.11 format supported_oper_classes"]
    pub supported_oper_classes: supported_oper_classes,
    #[doc = " station flags mask/set sta_flag_update sta_flag_update"]
...
pub struct umac_add_sta_info {
    ...
    #[doc = " Supported oper classes in IEEE 802.11 format supported_oper_classes"]
    pub supported_oper_classes: supported_oper_classes,
    #[doc = " station flags mask/set sta_flag_update"]
    pub sta_flags2: sta_flag_update,
    #[doc = " HT capabilities of station"]
    pub ht_capability: [::core::ffi::c_uchar; 256usize],
    #[doc = " VHT capabilities of station"]
...
pub struct umac_start_ap_info {
    ...
    pub flags: ::core::ffi::c_uint,
    #[doc = " Beacon frame, beacon_data"]
    pub beacon_data: beacon_data,
    #[doc = " SSID string, ssid"]
    pub ssid: ssid,
    #[doc = " Connect params, connect_common_info"]
    pub connect_common_info: connect_common_info,
...
pub struct umac_cmd_chg_vif_attr {
    ...
    #[doc = " Indicate which of the following parameters are valid"]
    pub valid_fields: ::core::ffi::c_uint,
    #[doc = " Interface attributes to be changed umac_chg_vif_attr_info"]
...
pub struct umac_mgmt_tx_info {
    ...
    #[doc = " Management frame to transmit, frame"]
    pub frame: frame,
...
pub struct umac_cmd_set_qos_map {
    #[doc = " Header umac_hdr"]
    pub umac_hdr: umac_hdr,
    #[doc = " qos map info. umac_qos_map_info"]
...
pub struct umac_cmd_config_twt {
    #[doc = " Header umac_hdr"]
    pub umac_hdr: umac_hdr,
    #[doc = " TWT configuration info umac_config_twt_info"]
...
#[repr(C, packed)]
pub struct umac_event_new_scan_results<FAM: ?Sized = [::core::ffi::c_uchar; 0]> {
    #[doc = " Header umac_hdr"]
    pub umac_hdr: umac_hdr,
    #[doc = " Indicate which of the following parameters are valid"]
    pub valid_fields: ::core::ffi::c_uint,
    ...
    pub ies: ::core::mem::ManuallyDrop<FAM>,
}
impl umac_event_new_scan_results<[::core::ffi::c_uchar]> {}
impl umac_event_new_scan_results<[::core::ffi::c_uchar; 0]> {}
...
#[repr(C, packed)]
pub struct umac_event_mlme<FAM: ?Sized = [::core::ffi::c_uchar; 0]> {
    #[doc = " Header umac_hdr"]
    pub umac_hdr: umac_hdr,
    #[doc = " Indicate which of the following parameters are valid"]
    pub valid_fields: ::core::ffi::c_uint,
    ...
    #[doc = " Frame data, including frame header and body frame"]
    pub frame: frame,
    ...
    #[doc = " ie's"]
    pub req_ie: ::core::mem::ManuallyDrop<FAM>,
}
impl umac_event_mlme<[::core::ffi::c_uchar]> {}
impl umac_event_mlme<[::core::ffi::c_uchar; 0]> {}
...
pub struct umac_event_new_station {
    ...
    pub generation: ::core::ffi::c_uint,
    #[doc = " Station information sta_info"]
...
pub struct umac_event_get_channel {
    #[doc = " Header umac_hdr"]
    pub umac_hdr: umac_hdr,
    #[doc = " Channel information.chan_definition"]
...
#[repr(C, packed)]
pub struct umac_event_power_save_info<FAM: ?Sized = [umac_config_twt_info; 0]> {
    #[doc = " Header umac_hdr"]
    pub umac_hdr: umac_hdr,
    ...
    #[doc = " TWT info of each flow umac_config_twt_info"]
    pub twt_flow_info: ::core::mem::ManuallyDrop<FAM>,
}
impl umac_event_power_save_info<[umac_config_twt_info]> {}
impl umac_event_power_save_info<[umac_config_twt_info; 0]> {}
...
pub struct event_sta_ht_cap {
    ...
    #[doc = " MCS information. event_mcs_info"]
...
pub struct event_get_wiphy {
    ...
    #[doc = " Wiphy name"]
    pub wiphy_name: [::core::ffi::c_schar; 32usize],
    #[doc = " Supported bands info. event_supported_band"]
...
#[repr(C, packed)]
pub struct reg<FAM: ?Sized = [get_reg_chn_info; 0]> {
    #[doc = " Header umac_hdr"]
    pub umac_hdr: umac_hdr,
    #[doc = " Country code"]
    ...
    pub chn_info: ::core::mem::ManuallyDrop<FAM>,
}
impl reg<[get_reg_chn_info]> {}
impl reg<[get_reg_chn_info; 0]> {}
...
#[repr(C, packed)]
#[derive(Debug, Copy, Clone)]
pub struct umac_cmd_config_quiet_period {
    #[doc = " Header umac_hdr"]
    pub umac_hdr: umac_hdr,
...
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq, num_enum::TryFromPrimitive)]
pub enum feature_flags {
    FEAT_SYSTEM_MODE = 1,
    FEAT_RADIO_TEST = 2,
    FEAT_SCAN_ONLY = 4,
    FEAT_SYSTEM_WITH_RAW_MODES = 8,
}
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq, num_enum::TryFromPrimitive)]
pub enum image_ids {
...
#[repr(C, packed)]
pub struct fw_image<FAM: ?Sized = [::core::ffi::c_uchar; 0]> {
    pub type_: ::core::ffi::c_uint,
    pub len: ::core::ffi::c_uint,
    pub data: ::core::mem::ManuallyDrop<FAM>,
}
impl fw_image<[::core::ffi::c_uchar]> {}
impl fw_image<[::core::ffi::c_uchar; 0]> {}
#[repr(C, packed)]
pub struct fw_image_info<FAM: ?Sized = [::core::ffi::c_uchar; 0]> {
...
impl fw_image_info<[::core::ffi::c_uchar]> {}
impl fw_image_info<[::core::ffi::c_uchar; 0]> {}
